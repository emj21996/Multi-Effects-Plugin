...
// my own version of DelayLine.cpp

CDelayLineEMJ::CDelayLineEMJ(void)
{
	// --- zero everything
	m_pBuffer = NULL;
	m_nSampleRate = 0;
...
void CDelayLineEMJ::init(int nDelayLength)
{
	// --- save for later
...
double CDelayLineEMJ::readDelay_mSec(double dmSec)
{
	// --- local variales
...
void CDelayLineEMJ::writeDelay(double dDelayInput)
{
